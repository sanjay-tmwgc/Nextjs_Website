   ...
   return (
    <div className='privacypolicy'>
        <div className='privacy-sub-one'>
            <p> <Link href='./' id='home'>Home </Link>&#62; Privacy policy</p>
            <h1>Privacy & Other policies<span>.</span></h1>
            <p>At <span>SKY FIANCIAL</span>, we are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy outlines how we collect, use, and safeguard your data when you visit our website or interact with our services.</p>
        </div>
